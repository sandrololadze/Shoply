...
export default function LoginScreen() {
  ...
  const handleGuest = async () => {
    try {
      ...
      Toast.show({ type: 'error', text1: 'Kon niet als gast doorgaan' });
    }
  };
    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.card}>
          ...
          <Button label="Sign In" onPress={handleSubmit(onSubmit)} loading={isLoading} style={styles.submitBtn} />
          ...
          {/* Gast knop */}
          <TouchableOpacity style={styles.guestBtn} onPress={handleGuest} disabled={isLoading}>
            <Text style={styles.guestText}>Doorgaan als gast</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  container: { flexGrow: 1, justifyContent: 'center', padding: Spacing.base, gap: Spacing.xl },
  header: { alignItems: 'center', gap: Spacing.sm },
  logo: { fontSize: 56 },
  appName: { fontSize: Typography['3xl'], fontWeight: Typography.extrabold, color: Colors.text, letterSpacing: -1 },
  ...
  cardTitle: { fontSize: Typography.xl, fontWeight: Typography.bold, color: Colors.text, marginBottom: Spacing.sm },
  ...
  eyeBtn: { position: 'absolute', right: 12, top: 0, bottom: 0, justifyContent: 'center', padding: Spacing.xs },
  eyeIcon: { fontSize: 18 },
  ...
  googleBtnText: { fontSize: Typography.base, fontWeight: Typography.semibold, color: Colors.text },
  guestBtn: { alignItems: 'center', paddingVertical: Spacing.sm },
  guestText: { fontSize: Typography.sm, color: Colors.textSecondary, textDecorationLine: 'underline' },
