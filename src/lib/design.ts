...
export function useColors() {
  ...
  const THEMES = [
    ...
    { primary: '#10B981', primaryLight: '#34D399', primaryDark: '#059669', primarySurface: '#ECFDF5' },
    { primary: '#3B82F6', primaryLight: '#60A5FA', primaryDark: '#2563EB', primarySurface: '#EFF6FF' },
    { primary: '#8B5CF6', primaryLight: '#A78BFA', primaryDark: '#7C3AED', primarySurface: '#F5F3FF' },
    { primary: '#EC4899', primaryLight: '#F472B6', primaryDark: '#DB2777', primarySurface: '#FDF2F8' },
    { primary: '#F97316', primaryLight: '#FB923C', primaryDark: '#EA580C', primarySurface: '#FFF7ED' },
  ];
...
// Statische fallback voor bestanden die Colors. gebruiken
export const Colors = {
  primary: '#6366F1',
  primaryLight: '#818CF8',
  primaryDark: '#4F46E5',
